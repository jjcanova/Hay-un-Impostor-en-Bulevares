...
// NUEVO: Iniciar primera partida manda categoría por defecto
...
// NUEVO: Verificador de clave para la categoría secreta
window.checkCategoryPassword = (selectObj) => {
    if (selectObj.value === 'cumple_jorge') {
        ...
        if (pass !== '1805') {
            ...
            selectObj.value = 'lugares'; // Lo devuelve a la categoría por defecto
        }
    }
};
...
// NUEVO: Agarra la categoría del selector al pasar de ronda
window.nextRound = () => { 
...
// NUEVO: Manda la categoría actual por si las dudas aunque use palabras customizadas
