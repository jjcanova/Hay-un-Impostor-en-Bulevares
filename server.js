...
io.on('connection', (socket) => {
    ...
    socket.on('joinRoom', (data) => {
        ...
        if (player) {
            ...
            // NUEVO: Permitir que jugadores se unan con el juego ya iniciado
            let newPlayer = { id: socket.id, username: data.username, role: 'PLAYER', palabra: null };
            
            // Si la sala está jugando, entra automáticamente como Detective
            ...
            if (room.status === 'playing') {
                // Enviar la pantalla de juego al nuevo jugador
                socket.emit('gameStarted', {
                ...
                // Actualizar la pantalla del Host para que vea al nuevo jugador en la lista
