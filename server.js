...
function iniciarPartida(code) {
    ...
    // 6. ENVÍO DE DATOS: Ahora que todos en 'room.players' tienen su rol, avisamos a cada uno
    room.players.forEach(p => {
        io.to(p.id).emit('gameStarted', {
            ...
            allPlayers: p.id === room.host ? room.players : null // Ahora room.players ya tiene los roles cargados
        });
    });
}
