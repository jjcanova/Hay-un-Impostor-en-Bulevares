...
// NUEVAS CATEGORÍAS Y PALABRAS EXPANDIDAS
const CATEGORIAS = {
    lugares: [
        { a: "Hospital", b: "Clínica" }, { a: "Banco", b: "Caja Fuerte" },
        { a: "Cine", b: "Teatro" }, { a: "Playa", b: "Río" },
        { a: "Universidad", b: "Colegio" }, { a: "Supermercado", b: "Kiosco" },
        { a: "Aeropuerto", b: "Terminal de Ómnibus" }, { a: "Restaurante", b: "Comedor" },
        { a: "Cementerio", b: "Iglesia" }, { a: "Boliche", b: "Bar" },
        { a: "Comisaría", b: "Cárcel" }, { a: "Chopería", b: "Cervecería Artesanal" }
    ],
    profesiones: [
        ...
        { a: "Programador", b: "Hacker" }, { a: "Político", b: "Sindicalista" },
        { a: "Profesor", b: "Preceptor" }, { a: "Sonidista", b: "Productor Musical" }
    ],
    comida: [
        { a: "Asado", b: "Parrillada" }, { a: "Empanadas de Osobuco", b: "Empanadas Cortadas a Cuchillo" },
        { a: "Pizza", b: "Calzone" }, { a: "Cerveza", b: "Vino" },
        { a: "Helado", b: "Postre" }, { a: "Hamburguesa", b: "Pancho" },
        { a: "Fideos", b: "Ñoquis" }, { a: "Mate", b: "Té" },
        { a: "Choripán", b: "Morcipán" }, { a: "Milanesa de Carne", b: "Milanesa de Pollo" },
        { a: "Locro", b: "Guiso de Lentejas" }, { a: "Fernet", b: "Campari" }
    ],
    deportes: [
        ...
        { a: "Automovilismo", b: "Karting" }, { a: "Maratón", b: "Atletismo" }
    ],
    argentina: [
        { a: "Obelisco", b: "Cabildo" }, { a: "Dulce de Leche", b: "Mermelada" },
        { a: "Alfajor", b: "Cubanito" }, { a: "Colectivo", b: "Subte" },
        { a: "Gaucho", b: "Paisano" }, { a: "Boleto Estudiantil", b: "SUBE" },
        { a: "Ruta 40", b: "Ruta 2" }, { a: "Mar del Plata", b: "Villa Carlos Paz" },
        { a: "Truco", b: "Póker" }, { a: "Envido", b: "Flor" },
        { a: "Tango", b: "Folclore" }, { a: "Cumbia", b: "Cuarteto" }
    ],
    futbol: [
        { a: "El Monumental", b: "La Bombonera" }, { a: "Copa Libertadores", b: "Copa Sudamericana" },
        { a: "Mundial 2022", b: "Copa América" }, { a: "Lionel Messi", b: "Diego Maradona" },
        { a: "Penal", b: "Tiro Libre" }, { a: "Director Técnico", b: "Ayudante de Campo" },
        { a: "Tarjeta Roja", b: "Tarjeta Amarilla" }, { a: "VAR", b: "Juez de Línea" },
        { a: "Clásico", b: "Derby" }, { a: "Hinchada", b: "Barrabrava" }
    ],
    cine: [
        { a: "El Padrino", b: "Buenos Muchachos" }, { a: "Star Wars", b: "Star Trek" },
        { a: "Harry Potter", b: "El Señor de los Anillos" }, { a: "Marvel", b: "DC Comics" },
        { a: "Cine", b: "Netflix" }, { a: "Terror", b: "Suspenso" },
        { a: "Comedia", b: "Stand Up" }, { a: "Esperando la Carroza", b: "El Secreto de sus Ojos" },
        { a: "Relatos Salvajes", b: "Nueve Reinas" }, { a: "El Marginal", b: "Okupas" }
    ],
    videojuegos: [
        { a: "PlayStation", b: "Xbox" }, { a: "Minecraft", b: "Roblox" },
        { a: "FIFA", b: "PES" }, { a: "Mario Bros", b: "Sonic" },
        { a: "GTA San Andreas", b: "GTA V" }, { a: "Call of Duty", b: "Counter Strike" },
        { a: "League of Legends", b: "Dota 2" }, { a: "Twitch", b: "YouTube Gaming" },
        { a: "Joystick", b: "Teclado y Ratón" }, { a: "Mundo Abierto", b: "Multijugador" }
    ],
    cumple_jorge: [
