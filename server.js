...
io.on('connection', (socket) => {
    ...
    // NUEVO: Agregar o quitar un impostor en vivo
    socket.on('changeImpostorCount', (data) => {
        ...
        let changed = false;
        if (data.delta > 0) {
            // Aumentar impostores: Elige un detective aleatorio y lo hace impostor
            ...
            // Disminuir impostores: Elige un impostor aleatorio y lo hace detective
